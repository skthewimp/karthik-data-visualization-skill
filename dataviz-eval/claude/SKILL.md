---
name: dataviz-eval
description: Evaluate a rendered chart or chart draft for legibility, correctness, and delivery readiness. Use when deciding whether a visualization is ready to send or needs another inspect→revise cycle.
metadata:
