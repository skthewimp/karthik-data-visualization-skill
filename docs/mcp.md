...
| `REDUNDANT_VALUE_AXIS` | The declared reading-carrying marks are directly labelled, or every mark is labelled, yet the numeric value axis still renders ticks - duplicate ink | Medium |
