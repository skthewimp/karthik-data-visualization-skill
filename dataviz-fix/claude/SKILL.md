...
In parallel, infer the raw data from the image as usual. Use exact values when the prompt supplies them; mark screenshot-derived values as approximate unless they are clearly printed source labels.
