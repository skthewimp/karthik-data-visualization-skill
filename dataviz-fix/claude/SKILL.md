...
python3 "${HERMES_SKILL_DIR}/scripts/case_manager.py" start \
  ...
  --skills-root "/home/karthik/apps/karthik-data-visualization-skill"
```
...
Send the image plus no more than three short lines: what changed, whether values are exact or approximate, and `MEDIA:/absolute/path/to/output.png`.
