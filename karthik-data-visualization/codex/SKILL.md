...
- Give every time label a reading job. Keep years or other time ticks when they locate unlabeled observations, establish intervals, or support comparison. If direct labels already identify every relevant time point and the axis only repeats them, remove the duplicate axis labels or reduce them to the few references needed for orientation.
